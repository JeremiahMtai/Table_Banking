		...
		<div class="card">
			<div class="card-header">
				<large class="card-title">
					<b>Loan List</b>
					<button class="btn btn-info btn-sm btn-block col-md-2 float-right" type="button" id="new_application"><i class="fa fa-plus"></i> Create New Application</button>
				</large>
				
			</div>
			<div class="card-body">
				<table class="table table-bordered bg success"  id="loan-list">
					<colgroup>
						<col width="10%">
						<col width="25%">
						<col width="25%">
					...
					<thead>
						<tr>
							...
							<th class="text-center">Savings <Details></Details></th>
							<th class="text-center">Next Savings Day</th>
