...
<div class="containe-fluid">
	...
	<div class="row mt-3 ml-3 mr-3">
			<div class="col-lg-12">
			<div class="card">
				<div class="cards" class="rounded-circle">
				...
				<div class="col-md-3">
                        <div class="card bg-success text-white mb-5" id="cards">
                        <style>
                         #cards{
                            ...
                            <img style="height: 150px;" src="assets/img/loan-cover.jpg" class="card-img-top rounded-circle" alt="">
                            <div class="cards">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3" class="row-card">
                ...
                <div class="col-md-3" id="cards">
                  ...
                  <div class="col-md-3">
                        <div class="card bg-warning text-white mb-3" id="cards">
                        <style>
                         #cards{
                            transition: all 0.2s ease;
                            cursor: pointer;
                        ...
                        <img style="height: 150px;" src="assets/img/active-loan.jpg" class="card-img-top rounded-circle" alt="">
                            <div class="cards">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                ...
                <div class="col-md-3">
                        <div class="card bg-info text-white mb-3" id="cards">
                        <style>
                         #cards{
                            transition: all 0.2s ease;
                            cursor: pointer;
